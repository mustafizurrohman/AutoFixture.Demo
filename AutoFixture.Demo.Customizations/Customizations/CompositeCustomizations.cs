...
public sealed class AllCustomization(string localization = Localizations.DefaultLocalization) : CompositeCustomization(
          ...
          new PersonContactCustomization(localization),
...
/// </summary>
public sealed class PersonCustomization(string localization = Localizations.DefaultLocalization) : CompositeCustomization(
...
/// </summary>
public sealed class ContactCustomization(string localization = Localizations.DefaultLocalization) : CompositeCustomization(
